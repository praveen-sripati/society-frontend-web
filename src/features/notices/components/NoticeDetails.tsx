import { ArrowLeftOutlined, DeleteOutlined, EditOutlined, FilePdfOutlined, HomeOutlined } from '@ant-design/icons';
import { Breadcrumb, Button, Card, Image, Modal, Tag, Tooltip, Typography, notification } from 'antd';
      ...
      <div className="max-w-[550px] mx-auto">
        ...
        <Card
          ...
          cover={
            <Image
              ...
              style={{ maxHeight: 500, objectFit: 'cover', objectPosition: 'right top' }}
        ...
        >
          <div className="flex justify-between items-start">
            ...
            {can('delete:notice') && (<Tooltip title="Delete Notice" key="edit">
                <Button
                  type="primary"
                  danger
                  icon={<DeleteOutlined />}
                  onClick={handleDelete}
                  shape="default" // Make it a circle
          ...
          <div className="flex justify-between items-center">
            <Tag color={CATEGORY_COLORS[notice.category]} className="self-end">
            ...
            <div className="flex flex-col items-end">
              <Text className="text-gray-400 block">Posted by: {notice.posted_by}</Text>
