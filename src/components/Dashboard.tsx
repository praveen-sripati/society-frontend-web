...
const Dashboard: React.FC = () => {
  ...
  const features = [
    ...
    {
      title: 'Security Check-in', // New card title
      description: 'Manage and pre-approve visitors', // New card description
      route: '/security-check-in', // New card route
      icon: <UsergroupAddOutlined />, // New card icon
    },
  ];
      ...
      <Row gutter={[16, 16]}>
        {features.map((feature, index) => (
          <Col xs={24} sm={12} md={8} lg={6} key={index}>
            <Card hoverable className="bg-yt-light-gray text-white h-full" onClick={() => navigate(feature.route)}>
